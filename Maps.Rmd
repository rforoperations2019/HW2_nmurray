...
ne_lines <- c("METRO-NORTH COMMUTER RAILROAD COMPANY, DBA: MTA METRO-NORTH RAILROAD",  
...
cols <- colorRampPalette(brewer.pal(8,"Dark2"))(length(ne_lines))
pal2 <-colorFactor(cols, domain = ne_lines)
